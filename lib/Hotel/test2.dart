...
class _dataTableTestState extends State<dataTableTest> {
  ...
  late DateTime _selectedDate1 = DateTime.now().add(Duration(days: 1));
  late DateTime _selectedDate2 = DateTime.now().add(Duration(days: 2));
  late DateTime _selectedDate3 = DateTime.now().add(Duration(days: 3));
  late DateTime _selectedDate4 = DateTime.now().add(Duration(days: 4));
  late DateTime _selectedDate5 = DateTime.now().add(Duration(days: 5));
  late DateTime _selectedDate6 = DateTime.now().add(Duration(days: 6));
